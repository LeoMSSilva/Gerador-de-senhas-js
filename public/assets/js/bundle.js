...
var labelNumber = document.querySelector('#labelNumber');
var labelUppercase = document.querySelector('#labelUppercase');
var labelLowercase = document.querySelector('#labelLowercase');
var labelSymbol = document.querySelector('#labelSymbol');
form.addEventListener('click', function () {
  size.value > 0 ? labelSize.classList.remove('disable') : labelSize.classList.add('disable');
  number.checked ? labelNumber.classList.remove('disable') : labelNumber.classList.add('disable');
  uppercase.checked ? labelUppercase.classList.remove('disable') : labelUppercase.classList.add('disable');
  lowercase.checked ? labelLowercase.classList.remove('disable') : labelLowercase.classList.add('disable');
  symbol.checked ? labelSymbol.classList.remove('disable') : labelSymbol.classList.add('disable');
});
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n\t--white: #fcfcfc;\n\t--primary-color: #003f9e;\n\t--second-color: #4a8ff7;\n\t--disable-color: #fcfcfcb3;\n}\n\n* {\n\toutline: 0;\n\tfont-family: 'Open sans', sans-serif;\n\tfont-weight: bold;\n\ttext-align: center;\n\tbox-sizing: border-box;\n\ttext-transform: uppercase;\n\tmargin: 0;\n\tpadding: 0;\n}\n\n.disable {\n\tcolor: var(--disable-color);\n}\n\nbody {\n\tbackground-color: var(--primary-color);\n}\n\n.container {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tjustify-content: center;\n\tline-height: 1.8em;\n\tfont-size: 1.2em;\n\tmax-width: 30rem;\n\tmax-height: 40rem;\n\tmargin: 6rem auto;\n\tpadding: 2rem 0rem 1rem;\n\tborder-radius: 1.5rem;\n\tborder: solid 1px var(--white);\n}\n\n#form {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tcolor: var(--white);\n}\n\n#form .row {\n\tdisplay: flex;\n\tflex-direction: row;\n\tmargin: 1rem 0;\n}\n\n#form .row .col {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tjustify-content: space-around;\n}\n\n#form .row .col2 {\n\talign-items: flex-start;\n\tmargin-left: 1rem;\n\tline-height: 1.8em;\n}\n\ninput {\n\twidth: 1rem;\n\theight: 2rem;\n\tborder-radius: 0.5rem;\n\tborder: 1px solid var(--white);\n}\n\ninput[type='number'] {\n\twidth: 3rem;\n\theight: 1.8rem;\n\tcolor: var(--white);\n\tbackground-color: var(--primary-color);\n\tline-height: 1em;\n\tfont-size: 0.8em;\n}\n\nh1 {\n\twidth: 100%;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\tmargin-bottom: 1rem;\n}\n\nh1,\nh2,\nbutton {\n\tbackground-color: var(--white);\n\tcolor: var(--primary-color);\n\theight: 3rem;\n}\n\nbutton {\n\twidth: 9rem;\n\tfont-size: 1.2em;\n\tborder-radius: 20rem;\n\tborder: none;\n\tcursor: pointer;\n}\n\nbutton:hover {\n\tbackground-color: var(--second-color);\n\tcolor: var(--white);\n}\n\n#result {\n\tbackground-color: var(--primary-color);\n\tcolor: var(--white);\n\tmax-width: 96%;\n\tword-wrap: break-word;\n\theight: 8rem;\n}\n\n@media only screen and (max-width: 768px) {\n\t.container {\n\t\tline-height: 1.6em;\n\t}\n\n\t#form .row .col2 {\n\t\tline-height: 1.6em;\n\t}\n\n\tinput {\n\t\theight: 1.5rem;\n\t}\n\n\tinput[type='number'] {\n\t\twidth: 2.5rem;\n\t\theight: 1.5rem;\n\t\tfont-size: 0.7125em;\n\t}\n}\n\n@media only screen and (max-width: 576px) {\n\tbody {\n\t\tpadding: 0 1rem;\n\t}\n\n\t.container {\n\t\tline-height: 1.4em;\n\t\tfont-size: 1.1em;\n\t}\n\n\t#form .row .col2 {\n\t\tline-height: 1.4em;\n\t}\n\n\tinput {\n\t\theight: 1.4rem;\n\t}\n\n\tinput[type='number'] {\n\t\twidth: 2.4rem;\n\t\theight: 1.3rem;\n\t}\n}\n@media only screen and (max-width: 420px) {\n\t.container {\n\t\tline-height: 1.2em;\n\t\tfont-size: 1em;\n\t}\n\n\t#form .row .col2 {\n\t\tline-height: 1.2em;\n\t}\n\n\tinput {\n\t\twidth: 0.8rem;\n\t\theight: 1.3rem;\n\t}\n\n\tinput[type='number'] {\n\t\twidth: 2.2rem;\n\t\theight: 1.2rem;\n\t\tfont-size: 0.65em;\n\t}\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;CACC,gBAAgB;CAChB,wBAAwB;CACxB,uBAAuB;CACvB,0BAA0B;AAC3B;;AAEA;CACC,UAAU;CACV,oCAAoC;CACpC,iBAAiB;CACjB,kBAAkB;CAClB,sBAAsB;CACtB,yBAAyB;CACzB,SAAS;CACT,UAAU;AACX;;AAEA;CACC,2BAA2B;AAC5B;;AAEA;CACC,sCAAsC;AACvC;;AAEA;CACC,aAAa;CACb,sBAAsB;CACtB,mBAAmB;CACnB,uBAAuB;CACvB,kBAAkB;CAClB,gBAAgB;CAChB,gBAAgB;CAChB,iBAAiB;CACjB,iBAAiB;CACjB,uBAAuB;CACvB,qBAAqB;CACrB,8BAA8B;AAC/B;;AAEA;CACC,aAAa;CACb,sBAAsB;CACtB,mBAAmB;CACnB,mBAAmB;AACpB;;AAEA;CACC,aAAa;CACb,mBAAmB;CACnB,cAAc;AACf;;AAEA;CACC,aAAa;CACb,sBAAsB;CACtB,mBAAmB;CACnB,6BAA6B;AAC9B;;AAEA;CACC,uBAAuB;CACvB,iBAAiB;CACjB,kBAAkB;AACnB;;AAEA;CACC,WAAW;CACX,YAAY;CACZ,qBAAqB;CACrB,8BAA8B;AAC/B;;AAEA;CACC,WAAW;CACX,cAAc;CACd,mBAAmB;CACnB,sCAAsC;CACtC,gBAAgB;CAChB,gBAAgB;AACjB;;AAEA;CACC,WAAW;CACX,aAAa;CACb,mBAAmB;CACnB,uBAAuB;CACvB,mBAAmB;AACpB;;AAEA;;;CAGC,8BAA8B;CAC9B,2BAA2B;CAC3B,YAAY;AACb;;AAEA;CACC,WAAW;CACX,gBAAgB;CAChB,oBAAoB;CACpB,YAAY;CACZ,eAAe;AAChB;;AAEA;CACC,qCAAqC;CACrC,mBAAmB;AACpB;;AAEA;CACC,sCAAsC;CACtC,mBAAmB;CACnB,cAAc;CACd,qBAAqB;CACrB,YAAY;AACb;;AAEA;CACC;EACC,kBAAkB;CACnB;;CAEA;EACC,kBAAkB;CACnB;;CAEA;EACC,cAAc;CACf;;CAEA;EACC,aAAa;EACb,cAAc;EACd,mBAAmB;CACpB;AACD;;AAEA;CACC;EACC,eAAe;CAChB;;CAEA;EACC,kBAAkB;EAClB,gBAAgB;CACjB;;CAEA;EACC,kBAAkB;CACnB;;CAEA;EACC,cAAc;CACf;;CAEA;EACC,aAAa;EACb,cAAc;CACf;AACD;AACA;CACC;EACC,kBAAkB;EAClB,cAAc;CACf;;CAEA;EACC,kBAAkB;CACnB;;CAEA;EACC,aAAa;EACb,cAAc;CACf;;CAEA;EACC,aAAa;EACb,cAAc;EACd,iBAAiB;CAClB;AACD","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n\t--white: #fcfcfc;\n\t--primary-color: #003f9e;\n\t--second-color: #4a8ff7;\n\t--disable-color: #fcfcfcb3;\n}\n\n* {\n\toutline: 0;\n\tfont-family: 'Open sans', sans-serif;\n\tfont-weight: bold;\n\ttext-align: center;\n\tbox-sizing: border-box;\n\ttext-transform: uppercase;\n\tmargin: 0;\n\tpadding: 0;\n}\n\n.disable {\n\tcolor: var(--disable-color);\n}\n\nbody {\n\tbackground-color: var(--primary-color);\n}\n\n.container {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tjustify-content: center;\n\tline-height: 1.8em;\n\tfont-size: 1.2em;\n\tmax-width: 30rem;\n\tmax-height: 40rem;\n\tmargin: 6rem auto;\n\tpadding: 2rem 0rem 1rem;\n\tborder-radius: 1.5rem;\n\tborder: solid 1px var(--white);\n}\n\n#form {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tcolor: var(--white);\n}\n\n#form .row {\n\tdisplay: flex;\n\tflex-direction: row;\n\tmargin: 1rem 0;\n}\n\n#form .row .col {\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tjustify-content: space-around;\n}\n\n#form .row .col2 {\n\talign-items: flex-start;\n\tmargin-left: 1rem;\n\tline-height: 1.8em;\n}\n\ninput {\n\twidth: 1rem;\n\theight: 2rem;\n\tborder-radius: 0.5rem;\n\tborder: 1px solid var(--white);\n}\n\ninput[type='number'] {\n\twidth: 3rem;\n\theight: 1.8rem;\n\tcolor: var(--white);\n\tbackground-color: var(--primary-color);\n\tline-height: 1em;\n\tfont-size: 0.8em;\n}\n\nh1 {\n\twidth: 100%;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\tmargin-bottom: 1rem;\n}\n\nh1,\nh2,\nbutton {\n\tbackground-color: var(--white);\n\tcolor: var(--primary-color);\n\theight: 3rem;\n}\n\nbutton {\n\twidth: 9rem;\n\tfont-size: 1.2em;\n\tborder-radius: 20rem;\n\tborder: none;\n\tcursor: pointer;\n}\n\nbutton:hover {\n\tbackground-color: var(--second-color);\n\tcolor: var(--white);\n}\n\n#result {\n\tbackground-color: var(--primary-color);\n\tcolor: var(--white);\n\tmax-width: 96%;\n\tword-wrap: break-word;\n\theight: 8rem;\n}\n\n@media only screen and (max-width: 768px) {\n\t.container {\n\t\tline-height: 1.6em;\n\t}\n\n\t#form .row .col2 {\n\t\tline-height: 1.6em;\n\t}\n\n\tinput {\n\t\theight: 1.5rem;\n\t}\n\n\tinput[type='number'] {\n\t\twidth: 2.5rem;\n\t\theight: 1.5rem;\n\t\tfont-size: 0.7125em;\n\t}\n}\n\n@media only screen and (max-width: 576px) {\n\tbody {\n\t\tpadding: 0 1rem;\n\t}\n\n\t.container {\n\t\tline-height: 1.4em;\n\t\tfont-size: 1.1em;\n\t}\n\n\t#form .row .col2 {\n\t\tline-height: 1.4em;\n\t}\n\n\tinput {\n\t\theight: 1.4rem;\n\t}\n\n\tinput[type='number'] {\n\t\twidth: 2.4rem;\n\t\theight: 1.3rem;\n\t}\n}\n@media only screen and (max-width: 420px) {\n\t.container {\n\t\tline-height: 1.2em;\n\t\tfont-size: 1em;\n\t}\n\n\t#form .row .col2 {\n\t\tline-height: 1.2em;\n\t}\n\n\tinput {\n\t\twidth: 0.8rem;\n\t\theight: 1.3rem;\n\t}\n\n\tinput[type='number'] {\n\t\twidth: 2.2rem;\n\t\theight: 1.2rem;\n\t\tfont-size: 0.65em;\n\t}\n}\n"],"sourceRoot":""}]);
// Exports
